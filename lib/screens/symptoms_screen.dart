          ...
          : Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SearchBarWidget(hint: 'Cari Gejala di sini', icon: CupertinoIcons.search),
                  const SizedBox(height: 25),
                  const Text('Gejala', style: TextStyle(fontSize: 18, fontFamily: 'Poppins', fontWeight: FontWeight.w600)),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              setState(() {
                                isSelected ? selected.remove(s.id) : selected.add(s.id);
                              });
                            },
                            child: Row(
                              children: [
                                Checkbox(
                                  value: isSelected,
                                  onChanged: (v) => setState(() => v! ? selected.add(s.id) : selected.remove(s.id)),
                                  activeColor: const Color(0xFF22B3E3),
                                ),
                                Text(s.name, style: const TextStyle(fontSize: 14, fontFamily: 'Poppins', fontWeight: FontWeight.w500)),
                              ],
                            ),
                          ),
                        );
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: selected.isEmpty ? Colors.grey : const Color(0xFF22B3E3),
